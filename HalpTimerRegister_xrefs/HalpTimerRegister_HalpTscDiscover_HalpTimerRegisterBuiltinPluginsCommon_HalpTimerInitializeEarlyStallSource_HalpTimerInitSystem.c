/* Call path: HalpTimerRegister <- HalpTscDiscover <- HalpTimerRegisterBuiltinPluginsCommon <- HalpTimerInitializeEarlyStallSource <- HalpTimerInitSystem */
...
/* ===== Function: HalpTscDiscover @ 0x14051abe8 ===== */
__int64 HalpTscDiscover()
{
  ...
  {
    v5 = ((__int64 (__fastcall *)(__int64, __int64, __int64))guard_dispatch_icall_no_overrides)(v3, v2, v4);
    v6 = 0LL;
    if ( v5 )
      v6 = v5;
    v18 = v6;
...
LABEL_12:
  v13 = (__int64 (__fastcall *)())HalpTscInitialize;
  if ( v21 )
  {
  ...
  {
    v7 = (__int64 (__fastcall *)())HalpTscQueryCounter;
  }
  v14 = v7;
