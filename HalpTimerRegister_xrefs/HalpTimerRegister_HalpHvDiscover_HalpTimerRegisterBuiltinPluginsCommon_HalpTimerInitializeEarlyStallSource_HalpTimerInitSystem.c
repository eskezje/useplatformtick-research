/* Call path: HalpTimerRegister <- HalpHvDiscover <- HalpTimerRegisterBuiltinPluginsCommon <- HalpTimerInitializeEarlyStallSource <- HalpTimerInitSystem */
...
/* ===== Function: HalpHvDiscover @ 0x140518b10 ===== */
