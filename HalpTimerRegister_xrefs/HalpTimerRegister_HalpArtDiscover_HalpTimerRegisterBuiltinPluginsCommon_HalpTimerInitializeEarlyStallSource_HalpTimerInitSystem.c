/* Call path: HalpTimerRegister <- HalpArtDiscover <- HalpTimerRegisterBuiltinPluginsCommon <- HalpTimerInitializeEarlyStallSource <- HalpTimerInitSystem */
...
/* ===== Function: HalpArtDiscover @ 0x14051a274 ===== */
