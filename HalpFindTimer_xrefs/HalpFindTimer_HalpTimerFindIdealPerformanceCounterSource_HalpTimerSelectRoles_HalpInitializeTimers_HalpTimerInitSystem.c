/* Call path: HalpFindTimer <- HalpTimerFindIdealPerformanceCounterSource <- HalpTimerSelectRoles <- HalpInitializeTimers <- HalpTimerInitSystem */
...
/* ===== Function: HalpTimerFindIdealPerformanceCounterSource @ 0x1404f3ff0 ===== */
