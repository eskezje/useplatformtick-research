/* Call path: HalpFindTimer <- HalpTimerFindIdealWatchdog <- HalpTimerSelectRoles <- HalpInitializeTimers <- HalpTimerInitSystem */
...
/* ===== Function: HalpTimerFindIdealWatchdog @ 0x1404f4220 ===== */
