/* Call path: HalpFindTimer <- HalpTimerFindIdealScalingSource <- HalpTimerSelectRoles <- HalpInitializeTimers <- HalpTimerInitSystem */
...
/* ===== Function: HalpTimerFindIdealScalingSource @ 0x1404f4140 ===== */
