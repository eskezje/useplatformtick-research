/* Call path: HalpHpetSetMatchValue <- HalpHpetArmTimer <- HalpHpetDiscover <- HalpTimerRegisterBuiltinPluginsCommon <- HalpTimerInitializeEarlyStallSource <- HalpTimerInitSystem */
...
/* ===== Function: HalpHpetArmTimer @ 0x14046fd60 ===== */
