/* Call path: HalpHpetSetMatchValue <- HalpHpetAcknowledgeInterrupt <- HalpHpetDiscover <- HalpTimerRegisterBuiltinPluginsCommon <- HalpTimerInitializeEarlyStallSource <- HalpTimerInitSystem */
